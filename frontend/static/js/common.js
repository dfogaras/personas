...
const MODELS = [
    ...
    { value: 'openai/gpt-5.4-nano',           label: 'GPT-5.4 Nano',          maxTemp: 2.0, tooltip: 'A legolcsóbb OpenAI modell. Nagy mennyiségű, egyszerű feladatokhoz.' },
    { value: 'openai/gpt-5.4-mini',          label: 'GPT-5.4 Mini',          maxTemp: 2.0, tooltip: 'Gyors és olcsó OpenAI modell. Jó minőség alapfeladatokhoz.' },
    { value: 'openai/gpt-5.4',               label: 'GPT-5.4',               maxTemp: 2.0, tooltip: 'Az OpenAI egyik legerősebb modellje. Kiváló minőség, de drágább.' },
...
function personaMetaHtml(persona) {
    ...
    return `
        ...
        <div class="persona-meta-title">${persona.is_teacher ? '🎓 ' : ''}${persona.title || T.general}</div>
        ${createdBy}
    `;
}
